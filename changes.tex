...
\begin{itemize}
      ...
      \item \textbf{Lemma 5.13}: No longer claim that any arbitrary Mealy
            homomorphism is monotone, but rather restrict our setting to Mealy
            coalgebra over \(\mathbf{Pos}_\bot\) i.e.\ state sets are
            posets with a bottom element and Mealy homomorphisms are \(\bot\)-preserving
            monotone maps; this setting is one in which the Mealy homomorphisms
            are exactly the ones we want.
\end{itemize}
