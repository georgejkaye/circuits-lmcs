...
\begin{exa}
    The Belnap interpretation has a set of normalising equations, which mainly
    consists of the standard completeness equations for Boolean logic extended
    to act on Belnap values.
