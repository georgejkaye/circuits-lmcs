...
\begin{defi}
    ...
    \(\interpretation = \left(\sqsubseteq, \gateinterpretation\right)\)
    of Let \(\morph{\circuittofunci}{\ccircsigma}{\funci}\) be the PROP morphism
    with action%
...
\begin{defi}
    Let \(\streamtomealyi\) be the traced PROP morphism
    \(\morph{\streami}{\mealyi}\) with action \(f \mapsto \streamtomealy[f]{}\).
\end{defi}
