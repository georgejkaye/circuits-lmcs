...
\begin{proof}
    ...
    \), so the following line of reasoning holds:
    \[
...
\begin{proof}
    ...
    \(\mu_f^{i+1}(\sigma) = \proj{0}(f(\mu_f^i(\sigma), \sigma))\) for \(i \geq 0\).
    ...
    \begin{align}
        ...
        \streamderivative{(\mu_f^i)}{w}(\sigma),\sigma)). \label{eq:twdf-claim}
    \end{align}
    ...
    \begin{align*}
        ...
        \streamderivative{(\mu_f^i)}{u}(a\streamcons\sigma),a\streamcons\sigma))) & \text{(IH)}                                                                                                             \\
        ...
        \streamderivative{(\mu_f^i)}{ua}(\sigma), \sigma))
...
\begin{defi}
    ...
    \mapsto
    \proj{0}\mleft(
    \mealyfunctiontransition{f}\mleft(s, \listvar{r} \concat \listvar{a}\mright)\mright)
    \).
