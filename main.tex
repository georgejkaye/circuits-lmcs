...
\begin{proof}
    ...
    \(\mu_f^{i+1}(\sigma) = \proj{0}(f(\mu_f^i(\sigma), \sigma))\) for \(i \geq 1\).
    ...
    \[\streamderivative{(\mu_f^{i+1})}{w}(\sigma) = \proj{0}(
        ...
        \streamderivative{(\mu_f^i)}{w}(\sigma),\sigma)).\]
    ...
    \begin{align*}
        ...
        \streamderivative{(\mu_f^i)}{u}(a\streamcons\sigma),a\streamcons\sigma)))                                                                                             \\
