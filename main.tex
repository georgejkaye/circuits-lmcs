...
To do this we turn back to the notion of Mealy homomorphisms: for two circuits \(
...
\begin{proof}
    ...
    \).
    This induces monotone Mealy machines \((S_{\hat{f}, \listvar{s}}, \hat{f})\)
    ...
    subsequently the composite of these homomorphisms is also a monotone Mealy
    homomorphism; these homomorphisms will act as a decoder-encoder pair;
