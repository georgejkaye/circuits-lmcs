...
\begin{proof}
    ...
    These Mealy machines have equal stream functions so have the same behaviour;
    since we are operating over Mealy coalgebra of posets and monotone functions
    this means there exist monotone Mealy homomorphisms
    ...
    homomorphism so we have a decoder-encoder pair;
    by \autoref{thm:encoding} we have that \[
        \iltikzfig{circuits/productivity/mealy-form-wide}[core=\mealytofunc[\hat{f}],state=\listvar{s}, colour=seq]
        =
